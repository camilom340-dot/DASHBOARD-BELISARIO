                ...
                <div className="flex-1 min-w-0">
                    ...
                    {roiTir && (
                        <div className="mt-2 flex flex-wrap gap-1.5">
                            ...
                            <div className={clsx(
                                "px-2 py-0.5 rounded-md text-[10px] font-bold flex items-center gap-1",
                                roiTir.tirAnnual > 0.15 ? "bg-green-500/20 text-green-400 border border-green-500/30" :
                                    roiTir.tirAnnual > 0 ? "bg-yellow-500/20 text-yellow-400 border border-yellow-500/30" :
                                        "bg-red-500/20 text-red-400 border border-red-500/30"
                            )}>
                                <span>💹</span>
                                <span>TIR: {(roiTir.tirAnnual * 100).toFixed(1)}%</span>
                            </div>
